...
static FREE_MEMORY: usize = 2_usize.pow(32);
...
fn test_memory() {
    ...
    assert_eq!(memory.free, vec![(0, FREE_MEMORY)]);
    ...
    assert_eq!(memory.free, vec![(0, FREE_MEMORY - 5)]);
}
